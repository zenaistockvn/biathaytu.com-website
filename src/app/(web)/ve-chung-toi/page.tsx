    ...
    <div className="web-app" style={{ backgroundColor: 'var(--web-bg)' }}>
      ...
      <section data-surface="ink" style={{ padding: '120px 0 60px', background: 'var(--web-ink)', color: '#fff', textAlign: 'center' }}>
        <div className="container" style={{ maxWidth: '800px' }}>
          ...
          <p style={{ fontSize: '18px', color: 'var(--web-on-ink-muted)', maxWidth: '650px', margin: '0 auto', lineHeight: 1.7 }}>Mang cả nền văn hóa bia Bavaria 400 năm tuổi đến với bàn tiệc của người Việt.</p>
        </div>
      </section>
      ...
      <article className="container" style={{ maxWidth: '850px', padding: '60px 20px 40px' }}>
        ...
        <h2 style={{ fontSize: '28px', fontWeight: 700, color: 'var(--web-ink)', marginBottom: '24px', fontFamily: 'var(--font-display)' }}>Sứ mệnh phân phối</h2>
        ...
        <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--web-ink)', marginBottom: '16px', fontFamily: 'var(--font-display)' }}>Thông tin liên hệ</h2>
