    ...
    <div className="web-app" style={{ backgroundColor: 'var(--web-bg)' }}>
      ...
      <article className="container" style={{ maxWidth: '850px', padding: '60px 20px 40px' }}>
        ...
        <p style={{ fontSize: '16px', lineHeight: 1.8, color: 'var(--web-text-secondary)', marginBottom: '32px' }}>
          ...
          Xem <Link href="/chung-nhan-nhap-khau-chinh-hang" style={{ color: 'var(--web-gold-dark)', fontWeight: 600 }}>giấy tờ nhập khẩu chính hãng</Link> để yên tâm về nguồn gốc sản phẩm.
        </p>
        ...
        <div style={{ padding: '40px', background: 'var(--web-navy)', borderRadius: '16px', textAlign: 'center', color: '#fff' }}>
          ...
          <p style={{ fontSize: '16px', color: 'rgba(255,255,255,0.8)', marginBottom: '24px' }}>Trải nghiệm dịch vụ giao bia tận nơi nhanh chóng trong nội thành Hà Nội. Nếu bạn là đối tác kinh doanh, tham khảo <Link href="/bang-gia-si-dai-ly" style={{ color: 'var(--web-gold)', textDecoration: 'underline' }}>chính sách đại lý &amp; báo giá sỉ</Link> dành riêng cho doanh nghiệp.</p>
