    ...
    <div className="web-app" style={{ backgroundColor: 'var(--web-bg)' }}>
      ...
      <article className="container" style={{ maxWidth: '850px', padding: '60px 20px 40px' }}>
        <div style={{ background: 'var(--web-accent)', color: 'var(--web-ink)', padding: '24px 28px', borderRadius: '12px', marginBottom: '48px', fontSize: '16px', lineHeight: 1.7, fontWeight: 500 }}>
          <strong>Thay ngàn lời chúc thành công:</strong> Khác với vang hay các dòng rượu mạnh vốn đã quá phổ biến, Bia Đức nhập khẩu là một làn gió mới trong văn hóa tặng quà doanh nghiệp. Vừa sang trọng, độc đáo, lại dễ tiếp cận trong các bữa tiệc tri ân cuối năm. Xem toàn bộ <Link href="/san-pham" style={{ color: 'var(--web-ink)', fontWeight: 600, textDecoration: 'underline' }}>danh mục sản phẩm bia Đức</Link> của chúng tôi.
        </div>

        <h2 style={{ fontSize: '28px', fontWeight: 700, color: 'var(--web-ink)', marginBottom: '24px', fontFamily: 'var(--font-serif)' }}>Các tùy chọn Quà Tặng Doanh Nghiệp</h2>
        ...
        <div style={{ padding: '40px', background: 'var(--web-bg-section)', borderRadius: '16px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href="https://zalo.me/0899191313" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', padding: '14px 32px', background: 'var(--web-ink)', color: '#fff', fontWeight: 700, borderRadius: '8px', textDecoration: 'none' }}>Chat Zalo Bộ Phận B2B</a>
            <a href="tel:0899191313" style={{ display: 'inline-block', padding: '14px 32px', border: '2px solid var(--web-ink)', color: 'var(--web-ink)', fontWeight: 700, borderRadius: '8px', textDecoration: 'none' }}>Hotline Tư Vấn Quà Tặng</a>
          </div>
        </div>
      </article>
