    ...
    <div className="web-app" style={{ backgroundColor: 'var(--web-bg)' }}>
      ...
      <section data-surface="ink" style={{ padding: '120px 0 60px', background: 'var(--web-ink)', color: 'var(--web-on-ink)', textAlign: 'center' }}>
        <div className="container" style={{ maxWidth: '800px' }}>
          ...
          <p style={{ fontSize: '18px', color: 'var(--web-on-ink-muted)', maxWidth: '650px', margin: '0 auto', lineHeight: 1.7 }}>Khẳng định đẳng cấp doanh nghiệp với món quà chứa đựng 400 năm nghệ thuật ủ bia từ Bavaria.</p>
        </div>
      </section>
      ...
      <article className="container" style={{ maxWidth: '850px', padding: '60px 20px 40px' }}>
        <div style={{ background: 'var(--web-accent)', color: 'var(--web-on-ink)', padding: '24px 28px', borderRadius: '12px', marginBottom: '48px', fontSize: '16px', lineHeight: 1.7, fontWeight: 500 }}>
          <strong>Thay ngàn lời chúc thành công:</strong> Khác với vang hay các dòng rượu mạnh vốn đã quá phổ biến, Bia Đức nhập khẩu là một làn gió mới trong văn hóa tặng quà doanh nghiệp. Vừa sang trọng, độc đáo, lại dễ tiếp cận trong các bữa tiệc tri ân cuối năm. Xem toàn bộ <Link href="/san-pham" style={{ color: 'var(--web-on-ink)', fontWeight: 600, textDecoration: 'underline' }}>danh mục sản phẩm bia Đức</Link> của chúng tôi.
        </div>

        <h2 style={{ fontSize: '28px', fontWeight: 700, color: 'var(--web-ink)', marginBottom: '24px', fontFamily: 'var(--font-display)' }}>Các tùy chọn Quà Tặng Doanh Nghiệp</h2>
        ...
        <h2 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--web-ink)', marginBottom: '16px', fontFamily: 'var(--font-display)' }}>Đặc quyền khách hàng Doanh nghiệp</h2>
