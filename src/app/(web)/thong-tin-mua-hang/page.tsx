  ...
  return (
    <div className="subpage-wrap container" style={{ padding: '60px 20px', maxWidth: '900px' }}>
      ...
      <div style={{ lineHeight: 1.8, color: 'var(--web-text-secondary)', fontSize: '15px' }}>
        <section style={{ marginBottom: '28px', padding: '20px', background: 'var(--web-bg-section)', border: '1px solid var(--web-border)', borderRadius: '12px' }}>
          <h2 style={{ fontSize: '19px', color: 'var(--web-ink)', fontWeight: 700, marginBottom: '12px' }}>1. Tính chất của thông tin này</h2>
        ...
        <section style={{ marginBottom: '24px' }}>
          <h2 style={{ fontSize: '18px', color: 'var(--web-ink)', fontWeight: 700, marginBottom: '12px' }}>2. Kênh liên hệ và tư vấn sản phẩm</h2>
          <p>
        ...
        <section style={{ marginBottom: '24px' }}>
          <h2 style={{ fontSize: '18px', color: 'var(--web-ink)', fontWeight: 700, marginBottom: '12px' }}>3. Xác nhận giao dịch</h2>
        ...
        <section style={{ marginBottom: '24px' }}>
          <h2 style={{ fontSize: '18px', color: 'var(--web-ink)', fontWeight: 700, marginBottom: '12px' }}>4. Phương thức thanh toán được hỗ trợ khi có giao dịch</h2>
          ...
          <p style={{ marginTop: '10px', color: 'var(--web-text-muted)', fontSize: '14px' }}>Website không thu thập thông tin thẻ, tài khoản ngân hàng hoặc dữ liệu thanh toán của khách hàng.</p>
        </section>

        <section style={{ marginBottom: '24px' }}>
          <h2 style={{ fontSize: '18px', color: 'var(--web-ink)', fontWeight: 700, marginBottom: '12px' }}>5. Giao nhận và kiểm soát độ tuổi</h2>
        ...
        <section style={{ marginBottom: '24px' }}>
          <h2 style={{ fontSize: '18px', color: 'var(--web-ink)', fontWeight: 700, marginBottom: '12px' }}>6. Đổi trả đối với giao dịch đã phát sinh</h2>
        ...
        <section style={{ marginBottom: '24px' }}>
          <h2 style={{ fontSize: '18px', color: 'var(--web-ink)', fontWeight: 700, marginBottom: '12px' }}>7. Cần hỗ trợ thêm?</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', color: 'var(--web-ink)', fontWeight: 700, marginBottom: '12px' }}>8. Thông tin đơn vị vận hành</h2>
