...
export default function PurchaseInformationPage() {
  ...
  return (
    <EditorialPage tone="light" hero={{ eyebrow: "Thông Tin Tham Khảo", title: "Thông Tin Mua Hàng", lead: "Website không thực hiện đặt hàng trực tuyến. Nội dung dưới đây giúp khách hàng hiểu cách liên hệ, phương thức giao dịch, nhận hàng và yêu cầu hỗ trợ sau khi một giao dịch đã được xác nhận qua kênh liên hệ hoặc tại địa điểm kinh doanh." }}>
      ...
      <div>
        <section>
          <h2>1. Tính chất của thông tin này</h2>
          <p>Đây là thông tin tham khảo về quy trình hỗ trợ khách hàng, không phải điều khoản giao dịch trực tuyến và không tạo thành một đơn hàng khi người dùng chỉ xem sản phẩm, điền form tư vấn hoặc nhắn tin qua website.</p>
        </section>

        <section>
          <h2>2. Kênh liên hệ và tư vấn sản phẩm</h2>
          <p>
        ...
        <section>
          <h2>4. Phương thức thanh toán được hỗ trợ khi có giao dịch</h2>
          ...
          <p>Website không thu thập thông tin thẻ, tài khoản ngân hàng hoặc dữ liệu thanh toán của khách hàng.</p>
        </section>

        <section>
          <h2>5. Giao nhận và kiểm soát độ tuổi</h2>
          ...
          <p>Tại Hà Nội, phương án giao trong ngày có thể được trao đổi khi khách hàng liên hệ hotline và điều kiện vận hành tại thời điểm đó cho phép.</p>
        </section>

        <section>
          <h2>6. Đổi trả đối với giao dịch đã phát sinh</h2>
          ...
          <p>Để được hỗ trợ thuận tiện, khách hàng nên phản hồi sớm sau khi nhận hàng. Kết quả xử lý phụ thuộc vào tình trạng thực tế, bằng chứng liên quan và nội dung đã được hai bên xác nhận trong giao dịch cụ thể.</p>
        </section>

        <section>
          <h2>7. Cần hỗ trợ thêm?</h2>
        ...
        <section>
          <h2>8. Thông tin đơn vị vận hành</h2>
