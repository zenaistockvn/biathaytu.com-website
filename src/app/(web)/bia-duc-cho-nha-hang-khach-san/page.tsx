    ...
    <div className="web-app" style={{ backgroundColor: 'var(--web-bg)' }}>
      ...
      <article className="container" style={{ maxWidth: '850px', padding: '60px 20px 40px' }}>
        ...
        <p style={{ fontSize: '16px', lineHeight: 1.8, color: 'var(--web-text-secondary)', marginBottom: '32px' }}>
           Chúng tôi không chỉ bán bia, chúng tôi cung cấp giải pháp. Chuyên gia của Bia Thầy Tu sẽ làm việc trực tiếp với Bếp trưởng/Quản lý nhà hàng của bạn để thiết kế <Link href="/food-pairing-bia-duc" style={{ color: 'var(--web-gold-dark)', fontWeight: 600 }}>gợi ý food pairing cho thực đơn</Link> phù hợp nhất:
        </p>
        ...
        <div style={{ padding: '40px', background: 'var(--web-bg-section)', borderRadius: '16px', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '16px', color: 'var(--web-text-secondary)', marginBottom: '24px' }}>Để lại thông tin, chuyên viên tư vấn B2B của chúng tôi sẽ liên hệ trong vòng 2 giờ làm việc. Xem chi tiết <Link href="/bang-gia-si-dai-ly" style={{ color: 'var(--web-navy)', fontWeight: 600, textDecoration: 'underline' }}>chính sách giá sỉ dành cho đại lý</Link>.</p>
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href="https://zalo.me/0899191313" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', padding: '14px 32px', background: 'var(--web-navy)', color: '#fff', fontWeight: 700, borderRadius: '8px', textDecoration: 'none' }}>Chat Zalo B2B</a>
            <a href="tel:0899191313" style={{ display: 'inline-block', padding: '14px 32px', border: '2px solid var(--web-navy)', color: 'var(--web-navy)', fontWeight: 700, borderRadius: '8px', textDecoration: 'none' }}>Gọi Hotline Phụ Trách Horeca</a>
          </div>
        </div>
      </article>
