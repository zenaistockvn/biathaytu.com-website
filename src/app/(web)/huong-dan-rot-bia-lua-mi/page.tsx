    ...
    <div className="web-app" style={{ backgroundColor: 'var(--web-bg)' }}>
      ...
      <article className="container" style={{ maxWidth: '850px', padding: '60px 20px 40px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '24px', marginBottom: '48px' }}>
          <div style={{ padding: '24px', background: 'var(--web-card-bg)', borderRadius: '16px', border: '1px solid var(--web-border)', display: 'flex', gap: '24px', alignItems: 'flex-start' }}>
            <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--web-ink)', color: 'var(--web-on-ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', fontWeight: 700, flexShrink: 0 }}>1</div>
            <div>
              <h3 style={{ fontSize: '20px', fontWeight: 700, color: 'var(--web-ink)', marginBottom: '8px' }}>Chuẩn bị ly Weizen và tráng nước lạnh</h3>
          ...
          <div style={{ padding: '24px', background: 'var(--web-card-bg)', borderRadius: '16px', border: '1px solid var(--web-border)', display: 'flex', gap: '24px', alignItems: 'flex-start' }}>
            <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--web-ink)', color: 'var(--web-on-ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', fontWeight: 700, flexShrink: 0 }}>2</div>
            <div>
              <h3 style={{ fontSize: '20px', fontWeight: 700, color: 'var(--web-ink)', marginBottom: '8px' }}>Rót 3/4 chai với góc nghiêng 45 độ</h3>
          ...
          <div style={{ padding: '24px', background: 'var(--web-card-bg)', borderRadius: '16px', border: '1px solid var(--web-border)', display: 'flex', gap: '24px', alignItems: 'flex-start' }}>
            <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--web-ink)', color: 'var(--web-on-ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', fontWeight: 700, flexShrink: 0 }}>3</div>
            <div>
              <h3 style={{ fontSize: '20px', fontWeight: 700, color: 'var(--web-ink)', marginBottom: '8px' }}>Đánh thức men sống (Lắc nhẹ đáy chai)</h3>
          ...
          <div style={{ padding: '24px', background: 'var(--web-card-bg)', borderRadius: '16px', border: '1px solid var(--web-border)', display: 'flex', gap: '24px', alignItems: 'flex-start' }}>
            <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--web-ink)', color: 'var(--web-on-ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', fontWeight: 700, flexShrink: 0 }}>4</div>
            <div>
              <h3 style={{ fontSize: '20px', fontWeight: 700, color: 'var(--web-ink)', marginBottom: '8px' }}>Tạo "vương miện" bọt hoàn hảo</h3>
        ...
        <div style={{ padding: '40px', background: 'var(--web-bg-section)', borderRadius: '16px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/san-pham" style={{ display: 'inline-block', padding: '14px 32px', background: 'var(--web-ink)', color: 'var(--web-on-ink)', fontWeight: 700, borderRadius: '8px', textDecoration: 'none' }}>Mua Bia Benediktiner Chính Hãng</Link>
          </div>
        </div>
      </article>
