    ...
    <div className="web-app" style={{ backgroundColor: 'var(--web-bg)' }}>
      ...
      <section style={{ padding: '120px 0 60px', background: 'var(--web-ink)', color: '#fff', textAlign: 'center' }}>
        <div className="container" style={{ maxWidth: '800px' }}>
          <p style={{ fontSize: '13px', fontWeight: 700, letterSpacing: '3px', color: 'var(--web-accent)', textTransform: 'uppercase', marginBottom: '20px' }}>Nghệ Thuật Thưởng Thức</p>
      ...
      <article className="container" style={{ maxWidth: '850px', padding: '60px 20px 40px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '24px', marginBottom: '48px' }}>
          <div style={{ padding: '24px', background: '#fff', borderRadius: '16px', border: '1px solid var(--web-border)', display: 'flex', gap: '24px', alignItems: 'flex-start' }}>
            <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--web-ink)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', fontWeight: 700, flexShrink: 0 }}>1</div>
            <div>
          ...
          <div style={{ padding: '24px', background: '#fff', borderRadius: '16px', border: '1px solid var(--web-border)', display: 'flex', gap: '24px', alignItems: 'flex-start' }}>
            <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--web-ink)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', fontWeight: 700, flexShrink: 0 }}>2</div>
            <div>
          ...
          <div style={{ padding: '24px', background: '#fff', borderRadius: '16px', border: '1px solid var(--web-border)', display: 'flex', gap: '24px', alignItems: 'flex-start' }}>
            <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--web-ink)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', fontWeight: 700, flexShrink: 0 }}>3</div>
            <div>
          ...
          <div style={{ padding: '24px', background: '#fff', borderRadius: '16px', border: '1px solid var(--web-border)', display: 'flex', gap: '24px', alignItems: 'flex-start' }}>
            <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--web-ink)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', fontWeight: 700, flexShrink: 0 }}>4</div>
            <div>
