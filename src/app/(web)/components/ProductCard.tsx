            ...
            {price ? (
              <>
                <button
                  ...
                  style={{ flex: 1, textAlign: 'center', fontSize: '14px', padding: '10px', border: '1px solid var(--web-primary)', backgroundColor: 'transparent', color: 'var(--web-primary)', cursor: 'pointer', borderRadius: '4px', fontWeight: 600, display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                  title="Thêm vào giỏ"
                >
