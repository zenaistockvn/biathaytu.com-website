      ...
      <div className="container footer-grid">
        <div>
          ...
          <div className="footer-socials" style={{ marginTop: '20px', display: 'flex', gap: '12px' }}>
            <a href="https://zalo.me/0899191313" target="_blank" rel="noopener noreferrer" className="footer-social-icon" title="Zalo" style={{ fontSize: '13px', fontWeight: 800 }}>ZALO</a>
            <a href="tel:0899191313" className="footer-social-icon" title="Hotline">
            ...
            <a href="mailto:info@biathaytu.com" className="footer-social-icon" title="Email">
