...
export default function FloatingZaloCTA() {
  ...
  return (
    <div className="floating-contact-stack" aria-label="Liên hệ nhanh">
      {/* Sub-buttons expand upwards above main Zalo button */}
      <a
        href="tel:0899191313"
        className={`floating-contact-button floating-phone-cta ${isExpanded ? 'is-visible' : 'is-hidden'}`}
      ...
      <a
        ...
        className={`floating-contact-button floating-messenger-cta ${isExpanded ? 'is-visible' : 'is-hidden'}`}
