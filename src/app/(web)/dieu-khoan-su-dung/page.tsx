    ...
    <div className="subpage-wrap container" style={{ padding: '60px 20px', maxWidth: '900px' }}>
      ...
      <div style={{ lineHeight: '1.8', color: '#464e66', fontSize: '15px' }}>
        <section style={{ marginBottom: '28px', padding: '20px', background: 'var(--web-bg-section)', border: '1px solid var(--web-border)', borderRadius: '12px' }}>
          <h2 style={{ fontSize: '19px', color: '#1c3157', fontWeight: '700', marginBottom: '12px' }}>1. Tính chất của website</h2>
          <p style={{ margin: 0 }}>
        ...
        <section style={{ marginBottom: '24px' }}>
          <h2 style={{ fontSize: '18px', color: '#1c3157', fontWeight: '700', marginBottom: '12px' }}>2. Điều kiện độ tuổi</h2>
        ...
        <section style={{ marginBottom: '24px' }}>
          <h2 style={{ fontSize: '18px', color: '#1c3157', fontWeight: '700', marginBottom: '12px' }}>3. Thông tin trên website</h2>
        ...
        <section style={{ marginBottom: '24px' }}>
          <h2 style={{ fontSize: '18px', color: '#1c3157', fontWeight: '700', marginBottom: '12px' }}>4. Quyền sở hữu nội dung</h2>
        ...
        <section style={{ marginBottom: '24px' }}>
          <h2 style={{ fontSize: '18px', color: '#1c3157', fontWeight: '700', marginBottom: '12px' }}>5. Liên kết và kênh liên hệ bên ngoài</h2>
        ...
        <section style={{ marginBottom: '24px' }}>
          <h2 style={{ fontSize: '18px', color: '#1c3157', fontWeight: '700', marginBottom: '12px' }}>6. Cập nhật điều khoản</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', color: '#1c3157', fontWeight: '700', marginBottom: '12px' }}>7. Thông tin đơn vị vận hành</h2>
