    ...
    <div className="subpage-wrap container" style={{ padding: '60px 20px', maxWidth: '900px' }}>
      ...
      <div style={{ lineHeight: '1.8', color: '#464e66', fontSize: '15px' }}>
        <section style={{ marginBottom: '24px' }}>
          <h2 style={{ fontSize: '18px', color: '#1c3157', fontWeight: '700', marginBottom: '12px' }}>1. Mục đích và phạm vi áp dụng</h2>
          <p>
        ...
        <section style={{ marginBottom: '24px' }}>
          <h2 style={{ fontSize: '18px', color: '#1c3157', fontWeight: '700', marginBottom: '12px' }}>2. Quy trình khai báo độ tuổi</h2>
          <p>
        ...
        <section style={{ marginBottom: '24px' }}>
          <h2 style={{ fontSize: '18px', color: '#1c3157', fontWeight: '700', marginBottom: '12px' }}>3. Cách xử lý dữ liệu khai báo</h2>
          <p>
        ...
        <section style={{ marginBottom: '24px' }}>
          <h2 style={{ fontSize: '18px', color: '#1c3157', fontWeight: '700', marginBottom: '12px' }}>4. Khả năng truy cập và công cụ tìm kiếm</h2>
          <p>
        ...
        <section style={{ marginBottom: '24px' }}>
          <h2 style={{ fontSize: '18px', color: '#1c3157', fontWeight: '700', marginBottom: '12px' }}>5. Liên hệ về kiểm soát độ tuổi</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', color: '#1c3157', fontWeight: '700', marginBottom: '12px' }}>6. Thông tin đơn vị vận hành</h2>
