  ...
  return (
    <div className="web-app" style={{ backgroundColor: 'var(--web-bg)' }}>
      ...
      <article className="container" style={{ maxWidth: '850px', padding: '60px 20px 40px' }}>
        ...
        <p style={{ marginTop: '16px', marginBottom: '24px' }}>Sẵn sàng đặt mua? Xem <a href="/mua-bia-benediktiner-chinh-hang" style={{ color: 'var(--web-accent-strong)', fontWeight: 600 }}>giá &amp; cách mua bia Benediktiner chính hãng →</a></p>
        ...
        <div style={{ padding: '32px', background: 'var(--web-ink)', borderRadius: '16px', color: '#fff', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/mua-bia-benediktiner-chinh-hang" style={{ display: 'inline-block', padding: '14px 32px', background: 'var(--web-accent)', color: 'var(--web-ink)', fontWeight: 700, borderRadius: '8px', textDecoration: 'none' }}>Xem Bảng Giá & Mua Hàng</Link>
          </div>
        </div>
      </article>
