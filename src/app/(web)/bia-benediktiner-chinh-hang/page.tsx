...
export const metadata: Metadata = {
  title: 'Bia Benediktiner Chính Hãng — Nhập Khẩu Nguyên Chai Từ Đức',
  description: 'Cách nhận biết và mua bia Benediktiner chính hãng tại Việt Nam. 100% nhập khẩu nguyên chai từ Đức, đầy đủ chứng từ nhập khẩu và bảo quản lạnh tiêu chuẩn.',
...
export default function Page() {
  return (
    <div className="web-app" style={{ backgroundColor: 'var(--web-bg)' }}>
      <JsonLd type="article" data={getArticleSchema({ title: 'Bia Benediktiner Chính Hãng', slug: 'bia-benediktiner-chinh-hang', description: 'Cách nhận biết bia Benediktiner chính hãng.', datePublished: '2026-04-24', dateModified: '2026-04-24' })} />
      ...
      <section style={{ background: 'var(--web-bg-section)', padding: '60px 0' }}>
        <div className="container" style={{ maxWidth: '780px' }}>
          ...
          <div style={{ padding: '24px', background: '#fff', borderRadius: '12px', border: '1px solid var(--web-border)', fontSize: '14px', lineHeight: 1.8, color: 'var(--web-text-secondary)' }}>
            ...
            <p><strong>Mua hàng uy tín:</strong> biathaytu.com · Hotline 091.531.2166.</p>
